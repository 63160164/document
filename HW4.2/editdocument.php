...
<body style="background-color:#483D8B">
    <div class="container">
        ...
        <form action="editdocument.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="doc_file_name"style='color:#EEDD82'>อัพโหลดไฟล์ :</label>
